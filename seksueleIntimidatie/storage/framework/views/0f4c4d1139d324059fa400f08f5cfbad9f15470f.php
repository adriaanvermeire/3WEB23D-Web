  ...
  <div class="container h-100 d-flex flex-column justify-content-between">
    <div class="row">
      <div class="col-4">
        ...
        <ul class='navigation'>
            <li>
              <a href="<?php echo route('home'); ?>" title="Hoofdpagina" class="">
                Hoofdpagina
                <span class="fa fa-home"></span>
              </a>
            </li>
            <li>
              <a href="<?php echo route('what.index'); ?>" title="Wat is intimidatie?" class="">
                Wat-is-het?
                <span class="fa fa-chevron-right"></span>
              </a>
            </li>
            <li>
              <a href="<?php echo route('reaction.index'); ?>" title="Hoe reageer je op intimidatie?" class="">
                Hoe reageren?<span class="fa fa-chevron-right"></span>
              </a>
            </li>
            <li>
              <a href="<?php echo route('contact.index'); ?>" title="Slachtoffer, getuige of dader?" class="">
                Waar kan je terecht?<span class="fa fa-chevron-right"></span>
              </a>
            </li>
            <li>
              <a href="<?php echo route('testimonials.index'); ?>" title="Leer uit verhalen van anderen" class="">
